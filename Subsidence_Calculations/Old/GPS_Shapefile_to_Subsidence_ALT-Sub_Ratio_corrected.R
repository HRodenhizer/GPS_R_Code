...
# A2009var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2009var.tif")
# B2009var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2009var.tif")
# C2009var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2009var.tif")
# A2011var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2011var.tif")
# B2011var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2011var.tif")
# C2011var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2011var.tif")
# A2015var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2015var.tif")
# B2015var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2015var.tif")
# C2015var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2015var.tif")
# A2016var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2016var.tif")
# B2016var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2016var.tif")
# C2016var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2016var.tif")
# A2017var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2017var.tif")
# B2017var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2017var.tif")
# C2017var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2017var.tif")
# A2018var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/A2018var.tif")
# B2018var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/B2018var.tif")
# C2018var <- raster("C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/C2018var.tif")
...
A2009varre <- resample(A2009var, A2017var, method = "bilinear")
B2009varre <- resample(B2009var, B2017var, method = "bilinear")
C2009varre <- resample(C2009var, C2017var, method = "bilinear")
A2011varre <- resample(A2011var, A2017var, method = "bilinear")
B2011varre <- resample(B2011var, B2017var, method = "bilinear")
C2011varre <- resample(C2011var, C2017var, method = "bilinear")
...
A2016varre <- resample(A2016var, A2017var, method = "bilinear")
B2016varre <- resample(B2016var, B2017var, method = "bilinear")
C2016varre <- resample(C2016var, C2017var, method = "bilinear")
...
# writeRaster(A2009re, "A2009K", format = "GTiff")
# writeRaster(B2009re, "B2009K", format = "GTiff")
# writeRaster(C2009re, "C2009K", format = "GTiff")
# writeRaster(A2011rer, "A2011K", format = "GTiff")
# writeRaster(B2011re, "B2011K", format = "GTiff")
# writeRaster(C2011re, "C2011K", format = "GTiff")
# writeRaster(A2015re, "A2015K", format = "GTiff")
# writeRaster(B2015re, "B2015K", format = "GTiff")
# writeRaster(C2015re, "C2015K", format = "GTiff")
# writeRaster(A2016re, "A2016K", format = "GTiff")
# writeRaster(B2016re, "B2016K", format = "GTiff")
# writeRaster(C2016re, "C2016K", format = "GTiff")
...
# writeRaster(A2018re, "A2018K", format = "GTiff")
# writeRaster(B2018re, "B2018K", format = "GTiff")
# writeRaster(C2018re, "C2018K", format = "GTiff")
# writeRaster(A2009varre, "A2009Var", format = "GTiff")
# writeRaster(B2009varre, "B2009Var", format = "GTiff")
# writeRaster(C2009varre, "C2009Var", format = "GTiff")
# writeRaster(A2011varre, "A2011Var", format = "GTiff")
# writeRaster(B2011varre, "B2011Var", format = "GTiff")
# writeRaster(C2011varre, "C2011Var", format = "GTiff")
# writeRaster(A2015varre, "A2015Var", format = "GTiff")
# writeRaster(B2015varre, "B2015Var", format = "GTiff")
# writeRaster(C2015varre, "C2015Var", format = "GTiff")
# writeRaster(A2016varre, "A2016Var", format = "GTiff")
# writeRaster(B2016varre, "B2016Var", format = "GTiff")
# writeRaster(C2016varre, "C2016Var", format = "GTiff")
...
# writeRaster(A2018varre, "A2018Var", format = "GTiff")
# writeRaster(B2018varre, "B2018Var", format = "GTiff")
# writeRaster(C2018varre, "C2018Var", format = "GTiff")

#Apply correction to necessary years
A2009corrected <- A2009re+1.2753
B2009corrected <- B2009re+1.2753
C2009corrected <- C2009re+1.2753
A2011corrected <- A2011re+1.2753
B2011corrected <- B2011re+1.2753
C2011corrected <- C2011re+1.2753
...
# setwd("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces")
# writeRaster(A2009corrected, "A2009RatioCorrected", format = "GTiff")
# writeRaster(B2009corrected, "B2009RatioCorrected", format = "GTiff")
# writeRaster(C2009corrected, "C2009RatioCorrected", format = "GTiff")
# writeRaster(A2011corrected, "A2011RatioCorrected", format = "GTiff")
# writeRaster(B2011corrected, "B2011RatioCorrected", format = "GTiff")
# writeRaster(C2011corrected, "C2011RatioCorrected", format = "GTiff")

#Calculate subsidence - finally!
A18_09Sub <- A2018re-A2009corrected
