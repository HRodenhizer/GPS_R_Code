...
DryPEHRThaw <- read_excel("Z:/Schuur Lab/New_Shared_Files/DATA/CiPEHR & DryPEHR/Thaw Depth/processed/Cumulative DryPEHR Thaw Data.xlsx",
                          col_types = c("guess", "guess", "guess", "guess", "guess", "guess", "guess", "guess", "guess", "text"))
...
A17_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2017SubClip_corrected.tif")
B17_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2017SubClip_corrected.tif")
C17_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2017SubClip_corrected.tif")
A16_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2016SubClip_corrected.tif")
B16_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2016SubClip_corrected.tif")
C16_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2016SubClip_corrected.tif")
# A15_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2015SubClip_corrected.tif")
# B15_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2015SubClip_corrected.tif")
# C15_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2015SubClip_corrected.tif")
A11_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2011SubClip_corrected.tif")
B11_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2011SubClip_corrected.tif")
C11_Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2011SubClip_corrected.tif")

# CiPEHR - Stack the subsidence rasters which are calculated from 2009
AstackC <- stack(A11_Sub, A16_Sub, A17_Sub)
BstackC <- stack(B11_Sub, B16_Sub, B17_Sub)
CstackC <- stack(C11_Sub, C16_Sub, C17_Sub)

# Subsidence rasters DryPEHR
A17_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2017_11SubClip_corrected.tif")
B17_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2017_11SubClip_corrected.tif")
C17_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2017_11SubClip_corrected.tif")
A16_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2016_11SubClip_corrected.tif")
B16_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2016_11SubClip_corrected.tif")
C16_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2016_11SubClip_corrected.tif")
# A15_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/A2015_11SubClip_corrected.tif")
# B15_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/B2015_11SubClip_corrected.tif")
# C15_11Sub <- raster("C://Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Kriged_Surfaces/Subsidence_Clipped/C2015_11SubClip_corrected.tif")

# DryPEHR - Stack the subsidence rasters which are calculated from 2011
AstackD <- stack(A16_11Sub, A17_11Sub)
BstackD <- stack(B16_11Sub, B17_11Sub)
CstackD <- stack(C16_11Sub, C17_11Sub)
...
AsubpointsC <- extract(AstackC, plotcoordsAC, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'A',
         sub2011 = A2011SubClip_corrected,
         sub2016 = A2016SubClip_corrected,
         sub2017 = A2017SubClip_corrected) %>%
  dplyr::select(block, sub2011, sub2016, sub2017) %>%
  cbind.data.frame(plotcoordsAC)

BsubpointsC <- extract(BstackC, plotcoordsBC, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'B',
         sub2011 = B2011SubClip_corrected,
         sub2016 = B2016SubClip_corrected,
         sub2017 = B2017SubClip_corrected) %>%
  dplyr::select(block, sub2011, sub2016, sub2017) %>%
...
CsubpointsC <- extract(CstackC, plotcoordsCC, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'C',
         sub2011 = C2011SubClip_corrected,
         sub2016 = C2016SubClip_corrected,
         sub2017 = C2017SubClip_corrected) %>%
  dplyr::select(block, sub2011, sub2016, sub2017) %>%
...
AsubpointsD <- extract(AstackD, plotcoordsAD, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'A',
         sub2016 = A2016_11SubClip_corrected,
         sub2017 = A2017_11SubClip_corrected) %>%
  dplyr::select(block, sub2016, sub2017) %>%
  cbind.data.frame(plotcoordsAD)

BsubpointsD <- extract(BstackD, plotcoordsBD, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'B',
         sub2016 = B2016_11SubClip_corrected,
         sub2017 = B2017_11SubClip_corrected) %>%
  dplyr::select(block, sub2016, sub2017) %>%
...
CsubpointsD <- extract(CstackD, plotcoordsCD, layer = 1, nl = 4) %>%
  as.data.frame() %>%
  mutate(block = 'C',
         sub2016 = C2016_11SubClip_corrected,
         sub2017 = C2017_11SubClip_corrected) %>%
  dplyr::select(block, sub2016, sub2017) %>%
...
subpoints <- subpointsC %>%
  ...
  dplyr::select(year, exp, block, fence, plot, treatment, subsidence, geometry = geometry.x) %>%
  ...
  filter(plot != 'a')
# write.csv(subpoints, 'C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/Subsidence_2009_2017_geoid_corrected.csv', row.names = FALSE)
...
# write.csv(coefs_subsidence, 'C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/CiPEHR_DryPEHR_Subsidence_Regression_Coefficients_geoid_corrected.csv', row.names = FALSE)
############################################################################################################
...
subfill <- subpoints %>%
  ...
  mutate(sub2010 = ifelse(exp == 'CiPEHR',
         ...
         sub2014 = ifelse(exp == 'CiPEHR',
                          ...
                          reg.intercept+reg.slope*3),
         sub2015 = ifelse(exp == 'CiPEHR',
                          reg.intercept+reg.slope*6,
                          reg.intercept+reg.slope*4)) %>%
  dplyr::select(exp, block, fence, plot, treatment, geometry, reg.intercept, reg.slope, reg.r2, reg.pvalue, sub2009, sub2010, sub2011, sub2012, sub2013, sub2014, sub2015, sub2016, sub2017) %>%
  gather(key = year, value = subsidence, sub2009:sub2017) %>%
  mutate(year = as.integer(str_sub(year, start = 4))) %>%
  filter(year == 2009 & exp != 'DryPEHR' | year == 2010 & exp != 'DryPEHR' | year > 2010)

# write.csv(subfill, 'C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/ALT_Subsidence_Correction_Regressions_2009_2017_geoid_corrected.csv', row.names = FALSE)
...
# Write file
# write.csv(ALTsub, 'C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/ALT_Subsidence_Corrected_2009_2017_geoid_corrected.csv', row.names = FALSE)
############################################################################################################

ALTsub <- read.csv('C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/ALT_Subsidence_Corrected_2009_2017_geoid_corrected.csv')
...
g1
# ggsave(plot = g1, "C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/Figures/Subsidence_lm_geoid_corrected.jpg", height = 8, width = 12)
...
g2 <- ggplot(ALTsubgraph, aes(x = year, y = ALT, color = Measurement_Type)) +
  ...
  theme(legend.title=element_blank(),
        ...
        strip.text.y = element_text(size = 12))
g2
# ggsave(plot = g2, "C:/Users/Heidi Rodenhizer/Documents/School/NAU/Schuur Lab/GPS/Thaw_Depth_Subsidence_Correction/Figures/Corrected_ALT_geoid_corrected.jpg", height = 8, width = 12)
